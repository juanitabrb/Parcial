...
<form>
    <div class="form-group">
        ...
        <input type="text" class="form-control mb-3" name ="respuesta1" id="respuesta1" value="{{$question->respuesta1}}">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control mb-3" name ="respuesta2" id="respuesta2" value="{{$question->respuesta2}}">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control mb-3" name ="respuesta3" id="respuesta3" value="{{$question->respuesta3}}">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control mb-3" name ="respuesta4"  id="respuesta4" value="{{$question->respuesta4}}">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control mb-3" name ="respuesta5" id="respuesta5" value="{{$question->respuesta5}}">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control mb-3" name ="respuesta6"  id="respuesta6" value="{{$question->respuesta6}}">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control mb-3" name ="respuesta7" id="respuesta7" value="{{$question->respuesta7}}">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control mb-3" name ="respuesta8" id="respuesta8" value="{{$question->respuesta8}}">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control mb-3" name ="respuesta9" id="respuesta9" value="{{$question->respuesta9}}">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control mb-3" name ="respuesta10"  id="respuesta10" value="{{$question->respuesta10}}">
        </div>
